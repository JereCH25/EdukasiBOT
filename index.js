...
case 'wikipedia':
               ...
               case 'nulis':
				...
				ct = body.slice(6)
				buffer = await getBuffer(`https://api.zeks.xyz/api/nulis?text=${ct}&apikey=apivinz`)
				client.sendMessage(from, buffer, image, {caption: 'Nih kak..', quoted: freply})
				break
                           }
		} catch (e) {
